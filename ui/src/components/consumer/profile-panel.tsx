    ...
    void gql<ProfileData>(
      ...
      .catch(() => {
        if (!cancelled) setData({
          me: { fullName: "", email: "", avatarUrl: null, userType: "", monthlyIncome: null, monthlySpend: null, investmentPct: null, housingCost: null, dependents: null, debtEmis: null, monthlyTax: null, emailNotifications: true },
          monthlyTab: { limit: 0 },
        });
      });
