      ...
      <CardContent className="flex flex-col items-center gap-3">
        {budget > 0 ? (
          <div
            ...
            style={{ background: `conic-gradient(${pct > 90 ? "#ef4444" : "#10b981"} ${pct * 3.6}deg, rgba(12,12,12,0.08) 0deg)` }}
          >
          ...
          <div className="flex h-28 w-28 items-center justify-center rounded-full bg-foreground/5">
