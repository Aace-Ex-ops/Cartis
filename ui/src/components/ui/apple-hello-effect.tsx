  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      >
        ...
        {/* C */}
        <motion.path
          d="M105 60 C75 45, 30 65, 30 110 C30 155, 75 175, 110 155"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.6),
        ...
        {/* a */}
        <motion.path
          d="M155 145 C135 125, 125 95, 155 95 C185 95, 185 155, 155 155 C135 155, 135 125, 185 125 M185 105 L185 155"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.7),
        ...
        {/* r */}
        <motion.path
          d="M225 155 L225 95 C245 95, 260 85, 270 105"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.5),
        ...
        {/* t */}
        <motion.path
          d="M310 50 L310 155 M285 95 L335 95"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.6),
        ...
        {/* i */}
        <motion.path
          d="M370 95 L370 155 M370 60 L370 68"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.4),
            ease: "easeInOut",
            delay: calc(2.0),
            opacity: { duration: 0.2, delay: calc(2.0) },
          }}
        />

        {/* s */}
        <motion.path
          d="M455 105 C430 90, 410 100, 410 120 C410 140, 455 135, 455 150 C455 165, 425 170, 405 155"
          initial={initialProps}
          animate={animateProps}
          transition={{
            duration: calc(0.7),
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, CartisHelloEffect };
