...
Usage:
    ...
    cartis-ai embed-chats              # every 5 min
"""
import argparse
import logging
import sys

from . import embed_chats, export_training_data, train_price_prediction, train_recommendations
